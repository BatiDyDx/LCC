...
// Estimacion del error para el metodo del trapecio compuesto
// eps debe ser una cota o estimacion del maximo de la segunda derivada de f
function err = error_trapecio(a, b, n, eps)
    h = (b - a) / n;
    err = - ((h ** 2) * (b - a) * eps) / 12;
endfunction
...
// Estimacion del error para el metodo de simpson compuesto
// eps debe ser una cota o estimacion del maximo de la cuarta derivada de f
