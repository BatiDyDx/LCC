...
static void *copiar_cadena(void *data) {
...
static void destruir_cadena(void *data) { free(data); }
static void imprimir_cadena(void *data, __attribute__((unused)) void *extra) {
