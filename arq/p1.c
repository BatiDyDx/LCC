...
// Ejercicio 1
void ex1() {
  assert(0 b10000000000000000000000000000000 == 1 << 31);
  assert(0 b10000000000000001000000000000000 == ((1 << 31) | (1 << 15)));
  assert(0 b11111111111111111111111100000000 == (-1 & -256));
  assert(0 b10101010000000000000000010101010 == (0xAA | (0xAA << 24)));
  assert(0 b00000000000000000000010100000000 == 5 << 8);
  assert(0 b11111111111111111111111011111111 == (-1 & (~(1 << 8))));
  assert(0 b11111111111111111111111111111111 == 0 - 1);
  assert(0 b00000000000000000000000000000000 == 0x80000000 + 0x80000000);
}
